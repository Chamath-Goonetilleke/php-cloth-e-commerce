...
// Set page variables
$pageTitle = "OneFit Clothing - Printed T-Shirts";
...
<section class="hero">
    <h1>Printed T-Shirts Collection</h1>
    <p>Discover our premium quality t-shirts that offer both comfort and style. Made from sustainable materials, our t-shirts are perfect for any occasion.</p>
    <a href="tshirts.php" class="btn">Shop Now</a><br>
</section>
        ...
        <?php else: ?>
            <?php foreach ($products as $product): ?>
                ...
                <div class="product-card">
                    ...
                    <p class="price">LKR <?php echo $product['price']; ?> LKR
...
<!-- Add this CSS to match the tshirts.html styling -->
<style>
    .hero {
